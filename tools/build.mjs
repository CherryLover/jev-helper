...
await Promise.all([
  build({entryPoints:{background:'src/background.mjs',popup:'src/popup.mjs',help:'src/help.mjs'},outdir:'dist',bundle:true,format:'esm',platform:'browser',target:'chrome120',logLevel:'info'}),
