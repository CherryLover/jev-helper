...
const mock=`
let settings={apiBase:'https://api.typesafe.ai/v1',model:'jev-latest',hotkey:'Alt+Shift+J',autoCamera:true,maxDecisions:2000,hasKey:true,language:localStorage.previewLanguage||'zh-CN'};
const now=Date.now();
